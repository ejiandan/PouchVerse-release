...
- SHA-256 fingerprinting identifies identical content regardless of filename, preventing duplicate storage.
...
- 80+ file formats: video, audio, images, PDF, Office documents, code, archives, and more.
...
- Custom TCP direct transfer protocol; no relay server, no account required.
- Cross-platform transfer between PouchVerse iOS, PouchVerse Transfer for macOS and Windows.

#### Biometric Private Space

- Fingerprint / face recognition protected in-app private folder; auto-locks on every background entry.
