...
> 📌 **PouchVerse Transfer**（macOS / Windows）는 데스크퇱용 LAN 파일 전송 컴패니언 앱입니다. 완전한 파일 관리는 **iOS 및 Android**에서 이용할 수 있습니다. **tvOS**는 Alpha 내부 테스트 중이며, **Android TV**는 출시 예정입니다. TV 버전은 iOS와 동일한 기능 체계를 갖추며, 사진·음악·영상 미리보기는 TV 조작에 최적화되어 있습니다.
