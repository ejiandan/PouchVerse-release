<!-- Hero Image -->
<p align="center">
  <img src="Assets/hero.png" alt="储物袋 PouchVerse — 移动端文件管理中心" width="100%">
</p>

<p align="center">
  <img src="https://img.shields.io/badge/iOS-v1.0.2_已上线-brightgreen?style=flat-square&logo=apple" alt="iOS v1.0.2 已上线">
  ...
  <a href="https://play.google.com/store/apps/details?id=com.ejiandan.pouchverse"><img src="https://img.shields.io/badge/Android-v1.0_已上线-brightgreen?style=flat-square&logo=android" alt="Android v1.0 已上线"></a>
  ...
  <a href="https://apps.apple.com/app/id6778987369"><img src="https://img.shields.io/badge/tvOS-v1.0_已上线-brightgreen?style=flat-square&logo=apple" alt="tvOS v1.0 已上线"></a>
...
手机相册、聊天记录、下载目录、各个应用里各自一份。
想找一份资料，经常要在不同地方来回切换，甚至重复保存多次。
...
有一张照片，是2026年夏天海边团建留下的。

如果用传统方式存放，它必须被放进某一个文件夹：
"2026"？"团建"？"海边"？"工作照片"？

但它本身不只属于一个位置。

于是我们开始重新思考"存放"这件事。
文件不再必须归属某一个文件夹，而是从一开始就不再被路径绑定。

物理存储被隐藏起来，用户不再直接面对结构。
取而代之的是信息本身被释放出来，可以同时被多个维度组织：
2026、夏天、海边、团建，都可以成为它的入口。

### 文件在进入的那一刻就被理解

当文件被导入系统时，它就已经发生变化。

它不再只是一个静态文件，而是被重新处理的信息单元：
指纹被计算，内容被识别，文本被提取，OCR被完成，索引被建立，缩略图被生成，中文还会进行拼音与首字母处理。

这一切发生在进入的瞬间。

传统文件夹不会做这些事情。
它只负责"放进去"，而这里负责"让它可以被找回来"。

文件从进入开始，就已经变得可理解、可检索、可关联。

### 信息在所有设备之间流动

当信息被结构化之后，它不再被设备限制。

手机与平板成为核心节点：负责导入、管理与承载数字资产。
桌面端成为处理节点：用于整理与加工重要内容，再回流系统。
电视端成为消费节点：所有信息可以瞬时同步，以流的方式被浏览与使用。

它们不再各自维护一套文件系统，而是共同使用同一套信息结构。

文件不再"在哪个设备里"，而是始终属于同一个系统，在不同场景中流动。
...
| 平台 | 状态 | 链接 |
|---|---|---|
| **iOS**（iPhone 和 iPad） | ✅ **v1.0.2 已上线** | [🛒 App Store](https://apps.apple.com/app/id6766184837) |
| **macOS** (Transfer) | ✅ **v1.0 已上线** | [🛒 App Store](https://apps.apple.com/app/id6773520285) |
| **Android** | ✅ **v1.0 已上线** | [🛒 Google Play](https://play.google.com/store/apps/details?id=com.ejiandan.pouchverse) |
...
| **tvOS**（Apple TV） | ✅ **v1.0 已上线** | [🛒 App Store](https://apps.apple.com/app/id6778987369) |
| **Android TV** | 🔜 即将推出 | — |

> 📌 **储物袋 Transfer**（macOS / Windows）为桌面平台提供局域网互传功能；完整文件管理功能适用于 **iOS 与 Android**；**tvOS** v1.0 版已上线 App Store，**Android TV** 版即将推出。电视版以手机 App 为数据源，是手机端功能的大屏延伸——在电视上畅享已存入储物袋的视频、图片与音乐。
>
...
- **邮件：** [support@ejiandan.com](mailto:support@ejiandan.com)
