...
> 📌 **储物袋 Transfer**（macOS / Windows）为桌面平台提供局域网互传功能；完整文件管理功能适用于 **iOS 与 Android**；**tvOS** 版正在进行 Alpha 内部测试，**Android TV** 版即将推出。电视版以手机 App 为数据源，是手机端功能的大屏延伸——在电视上畅享已存入储物袋的视频、图片与音乐；文件管理、导入导出与传输功能仅在手机端提供。
