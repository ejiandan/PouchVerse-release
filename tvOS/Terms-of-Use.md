...
to use the App for personal, non‑commercial purposes on Apple TV devices you
own or control.

## 2. The service

The App is a **client** that browses and plays media shared by PouchVerse hosts
on your local network. It does not host content, and it does not provide any
content itself. All media you view through the App originates from devices you
connect to.

## 3. Your responsibilities

- You are solely responsible for the content stored on the devices you connect
  to and for ensuring you have the right to access and play that content.
- You agree not to use the App to infringe the intellectual‑property rights of
  others or to violate any applicable law.
- You are responsible for keeping your devices and local network secure.

## 4. No warranty

The App is provided "as is" and "as available", without warranties of any kind,
express or implied, including but not limited to merchantability, fitness for a
particular purpose, and non‑infringement. Media discovery and streaming depend
on your network conditions and the host devices, and may not always succeed.
...
terminate the license if you breach these Terms.
